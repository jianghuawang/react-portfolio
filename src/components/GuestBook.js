...
export default class GuestBook extends Component {
    constructor(){
        ...
        this.firebasePush=(e)=>{
            ...
            this.setState({name:'',description:'',comment:'',email:''})
                ...
                <div className='formgrid'>
                    <form autoComplete="off" className="form formForGuest" onSubmit={this.firebasePush}>
                            ...
                            <div className="field">
                                ...
                                <input id="email" type="email" name='email' placeholder="Enter your email" className="input" value={this.state.email}  onChange={this.onChange}></input>
                            </div>
                            <div className="field">
